...
import sty from "./PlasmicButton.module.css"; // plasmic-import: OPOqV8Iym6qi/css
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg___7YGq1)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__zfzJ)}
                role={"img"}
              />
            ),
