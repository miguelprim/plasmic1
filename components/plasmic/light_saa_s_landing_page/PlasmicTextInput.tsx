...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 3qUrjcbW8ZGK/css
    ...
    >
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <Searchsvg2Icon
              className={classNames(projectcss.all, sty.svg___4Kgre)}
              role={"img"}
            />
          ),
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__nbcm6)}
              role={"img"}
            />
          ),
